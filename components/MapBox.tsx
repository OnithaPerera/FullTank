                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        ...
                        <button onClick={(e) => copyStationLink(e, station.id)} className={`flex-[0.55] flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-bold transition-colors active:scale-[0.98] ${copiedStationId === station.id ? 'bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-900/20 dark:text-emerald-400 dark:border-emerald-800/50' : 'bg-[var(--ui-surface-muted)] hover:bg-[var(--ui-surface-strong)] text-[var(--ui-text)] border border-[var(--ui-border)]'}`}>
